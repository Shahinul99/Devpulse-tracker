...
export const pool = new Pool({
  connectionString:"postgresql://neondb_owner:npg_kyNwgar7Soq9@ep-twilight-shape-ap6dzmj6-pooler.c-7.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require",
});
